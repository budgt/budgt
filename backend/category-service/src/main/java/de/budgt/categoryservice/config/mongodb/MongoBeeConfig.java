...
public class MongoBeeConfig {
  ...
  private static final String MONGODB_CHANGELOGS_PACKAGE = "de.budgt.categoryservice.config.mongodb.changelogs";
  ...
  public Mongobee mongobee() {
    ...
    runner.setLockCollectionName("mongobeelock-category");
